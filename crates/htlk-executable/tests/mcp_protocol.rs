//! Pinned descriptor/result schemas and native scalar URI-template expansion.
use htlk_cbor::{Limits, Map, Value};
use htlk_executable::{
    JsonDocument as J, McpBinding, McpBindingKind, McpDescriptorKind as K, McpTransport,
    McpValidationError as E, ServerIdentity, expand_uri_template, validate_mcp_descriptor,
    validate_mcp_prompt_result, validate_resource_snapshot,
};
fn j(s: &str) -> J {
