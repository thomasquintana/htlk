...
pub(crate) const DECLARED_FIELDS: &str = "x-htlk-private-declared-fields";

/// Accounts for declaration propagation through same-instance schema applicators.
/// Property/item children are separate instance locations and retain their own
/// annotations. Predicate-only schemas (not/if) do not declare projected fields.
#[derive(Default)]
