...
impl ScopeGraphPlan {
    ...
    pub(crate) fn environment(&self, site: &ExpressionSite) -> Option<&ExpressionTypeEnvironment> {
...
pub enum ScopeVerificationErrorKind {
    ...
    Expression(Box<crate::EvaluationError>),
...
fn expression_error(e: impl Into<crate::EvaluationError>) -> ScopeVerificationError {
...
/// CanonicalDocument has already checked definition closure and interfaces;
/// this stage adds expressions, binding compatibility, wait cycles, and observability.
///
/// # Errors
